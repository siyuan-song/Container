...
class ContainerConfig(Config):
    ...
    NUM_CLASSES = 1 + 7  # Background + (Cola bottle,Fanta bottle,Mtn Dew bottle,Coke Zero bottle,Cherry Coke bottle,Cola Can,Fanta Can)
...
class ContainerDataset(utils.Dataset):
    ...
    def load_container(self, dataset_dir, subset):
        ...
        self.add_class("container", 4, "Coke Zero Bottle")
        self.add_class("container", 5, "Mtn Dew Bottle")
        self.add_class("container", 6, "Cola Can")
        self.add_class("container", 7, "Fanta Can")
        ...
        for a in annotations:
            ...
            type_id = [type_dict[a] for a in type]
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        mask = np.zeros([info["height"], info["width"], len(info["polygons"])],
                        dtype=np.uint8)
        class_ids = np.array(type_id, dtype=np.int32)
